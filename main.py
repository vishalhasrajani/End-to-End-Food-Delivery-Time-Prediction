...
set_background_image('https://images.pexels.com/photos/4565295/pexels-photo-4565295.jpeg')
...
if st.markdown("""
    <h3 style="color: white; font-weight: bold; text-align: center;">Get ETA for Delivery!</h3>
    """, unsafe_allow_html=True):
